...
""",
    ...
    'depends': [
        'base', 'base_setup', 'product', 'mail', 'sale', 'delivery', 'web', 'mrp', 
        'hubi_menu', 'multi_table', 'tools', 'account_payment_mode', 'printing', 'hubi_printing', 'hubi_sale_order_toinvoice'#, 'hubi_edi_ftp' , 'hubi_palletization'
